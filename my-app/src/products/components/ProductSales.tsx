                    ...
                    <div className="product-content">
                        ...
                        <div className="u-container product__mgp-quality u-padding-horizontal-default">
                            <div className="mgp-quality page-section">
                                <div className="mgp-quality__header">
                                    <Reveal effect="fadeInDown">
                                        <h2 className="page-section__title">De la quantité oui. {size.width && size.width > 480 && <br/> }Mais de la qualité surtout.</h2>
                                    </Reveal>
                                    <p className="page-section__text">Nous utilisons de la viscose de <span className="u-underline">bambou biologique</span>{size.width && size.width > 510 && <br/>} pour des masques respirants et plus doux au toucher.</p>
                        ...
                        <div className="u-container product__mgp-design u-padding-horizontal-default">
                            <div className="mgp-design page-section">
                                ...
                                <p className="page-section__text">Chaque masque est imprimé de manière <span className="u-underline">aléatoire,</span>{size.width && size.width > 510 && <br/>} des milliers de combinaisons sont possibles et <span className="u-underline">chaque masque est unique</span>.</p>
                            </div>
                        </div>
                        ...
                        <div className="product__mgp-everyone page-section u-no-padding-bottom u-background-black u-font-light-grey u-padding-horizontal-default">
                            <div className="mgp-everyone u-bottom-border u-padding-bottom u-border-grey u-container">
                                ...
                                <p className="page-section__text">Créer un groupe de commande pour faire baisser le prix de votre masque {size.width && size.width > 700 && <br/>}jusqu'à <span className="u-underline u-underline-white">4 euros l'unité</span>.</p>
                            </div>
                        </div>
