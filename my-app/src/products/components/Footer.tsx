        ...
        <footer className="u-padding-horizontal-default">
            <div className="footer u-container">
                ...
                <div className="footer__info">
                    ...
                    <p>Contact : <span className="u-underline-grey">suppor@mgpmasks.com</span></p>
                    <ul className="info__social">
                        <li><a href="/" className="u-no-margin u-font-grey">Facebook.</a></li>
                        <li><a href="/" className="u-no-margin u-font-grey">Instagram.</a></li>
                        <li><a href="/" className="u-no-margin u-font-grey">Twitter.</a></li>
                    </ul>
                </div>
            </div>
        </footer>
